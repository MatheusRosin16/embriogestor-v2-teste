-- EMBRIOGESTOR FASE 14.15.4 — CORREÇÃO DE SINCRONIZAÇÃO POR PERFIL
-- Execute UMA VEZ no SQL Editor do Supabase.
-- Não altera senhas, usuários, owner_id nem permissões já cadastradas.
-- Atualiza somente a RPC que entrega o banco aos perfis.
--
-- Admin e Veterinário: recebem o banco completo do owner_id.
-- Cliente: recebe somente os dados do cliente vinculado + identidadeEmpresa.
-- A identidadeEmpresa é necessária para logo/nome funcionarem no login Cliente.
